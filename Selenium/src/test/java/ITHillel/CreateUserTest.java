...
public class CreateUserTest {
    ...
    public void testMethod() throws InterruptedException {
        ...
        driver.findElement(By.cssSelector("div.main-content input#icon_prefix")).sendKeys("Bel");
        driver.findElement(By.cssSelector("div.main-content input#icon_telephone")).clear();
        driver.findElement(By.cssSelector("div.main-content input#icon_telephone")).sendKeys("88005553535");
